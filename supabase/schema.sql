redirected into floor of it email password in it if you wait email password hand for now we have for now tolisten to idea managementcreate table if not exists public.products (
